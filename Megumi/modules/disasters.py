...
disasters = """ Megumi has bot access levels we call as *"Disaster Levels"*
...
Owner has complete bot access, including bot adminship in chats Megumi is at.
\n*Dragons* - Have super user access, can gban, manage disasters lower than them and are admins in Megumi.
\n*Demons* - Have access go globally ban users across Megumi.
...
\n*Disclaimer*: The disaster levels in Megumi are there for troubleshooting, support, banning potential scammers.
Report abuse or ask us more on these at [Tiger Union](https://t.me/tigerunion).
"""
